...
export default function ResultPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#fafafa] text-black">
      ...
      <aside className="w-64 bg-white border-r border-[#eaeaea] hidden lg:flex flex-col justify-between flex-shrink-0 print-hidden">
        <div>
          ...
          <div className="h-20 flex items-center px-6 border-b border-[#eaeaea]">
            ...
            <div>
              <span className="font-bold text-base tracking-tight text-black block">Student Portal</span>
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        ...
        <header className="lg:hidden h-16 bg-white border-b border-[#eaeaea] flex items-center justify-between px-6 print-hidden">
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 bg-black text-white flex items-center justify-center font-bold text-xs rounded">VIT</div>
        ...
        <div className="p-6 md:p-10 max-w-6xl mx-auto w-full">
            ...
            <div className="animate-fade-in space-y-8">
              ...
              <div className="glass-card p-8 rounded-2xl bg-gradient-to-r from-white via-white to-gray-50 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                  <div className="flex items-center gap-2.5 mb-2">
                    <span className="px-2.5 py-0.5 rounded-full text-[11px] font-bold bg-black text-white uppercase tracking-wider">
                      AY 2025-26
                    </span>
                  ...
                  <p className="text-sm text-[#666666] mt-1 font-normal">
                    PRN: <span className="font-mono font-bold text-black">{overview.student.prnNumber}</span> • Current Semester: <span className="font-bold text-black">Sem {overview.student.currentSemester}</span> • Batch: {overview.student.batch}
                  </p>
                </div>
                ...
                <div className="flex items-center gap-3">
                  <button 
                    ...
                    className="px-4 py-2 bg-black text-white text-xs font-semibold rounded-lg hover:bg-[#222222] transition-colors shadow-sm flex items-center gap-2"
                  >
                  ...
                  <button 
                    ...
                    className="px-4 py-2 bg-white text-black border border-[#eaeaea] text-xs font-semibold rounded-lg hover:bg-[#f5f5f5] transition-colors shadow-sm"
                  >
                    Hall Ticket
                  </button>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                <div className="glass-card p-6 rounded-2xl flex flex-col justify-between">
                  ...
                  <div className="my-3 flex items-baseline gap-1.5">
                    <span className="text-4xl font-black text-black">{overview.cgpa.toFixed(2)}</span>
                ...
                <div className="glass-card p-6 rounded-2xl flex flex-col justify-between">
                  ...
                  <div className="my-3 flex items-baseline gap-1.5">
                    <span className="text-4xl font-black text-black">{overview.totalCreditsEarned}</span>
                    <span className="text-xs text-[#888888] font-semibold">/ 160 Total</span>
                  </div>
                  <span className="text-[11px] font-medium text-black bg-gray-100 px-2 py-0.5 rounded w-fit">
                ...
                <div className="glass-card p-6 rounded-2xl flex flex-col justify-between">
                  ...
                  <div className="my-3 flex items-baseline gap-1.5">
                    <span className={`text-4xl font-black ${overview.isDefaulter ? 'text-red-600' : 'text-black'}`}>
                ...
                <div className="glass-card p-6 rounded-2xl flex flex-col justify-between">
                  ...
                  <div className="my-3">
                    <span className="text-3xl font-black text-emerald-600">CLEARED</span>
                  </div>
              ...
              <div className="glass-card p-7 rounded-2xl">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h2 className="text-base font-bold text-black">Semester Performance Progression</h2>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
                  {overview.semesterHistory.map((sem) => (
                    <div 
                      ...
                      className="cursor-pointer p-4 rounded-xl border border-[#eaeaea] bg-[#fafafa] hover:bg-black hover:text-white transition-all group flex flex-col justify-between h-28"
                    >
                      <span className="text-xs font-bold text-[#888888] group-hover:text-gray-300">Sem {sem.semester}</span>
                      <div>
                        <p className="text-2xl font-black text-black group-hover:text-white">{sem.sgpa.toFixed(2)}</p>
              ...
              <div className="glass-card p-7 rounded-2xl">
                <div className="flex items-center justify-between mb-5">
                  <h2 className="text-base font-bold text-black">Official University Circulars</h2>
                  <button onClick={() => setActiveModule('notices')} className="text-xs font-semibold text-black hover:underline">
                    View All Circulars →
                  </button>
                </div>
                ...
                <div className="space-y-3">
                  {notices.slice(0, 3).map((notice) => (
                    <div key={notice.id} className="p-4 rounded-xl border border-[#eaeaea] bg-white flex flex-col md:flex-row md:items-center justify-between gap-3 hover:border-black transition-colors">
                      <div className="space-y-1">
                        ...
                        <h4 className="text-sm font-bold text-black">{notice.title}</h4>
                      </div>
          ...
          {activeModule === 'results' && (
            <div className="animate-fade-in space-y-6">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                  <h1 className="text-2xl font-black text-black">Multi-Semester Gradebook</h1>
                  <p className="text-xs text-[#666666] mt-0.5">Explore detailed marks, credit distribution, and grade points for each semester</p>
                </div>

                <button 
                  onClick={() => setActiveModule('gradesheet')}
                  className="px-4 py-2 bg-black text-white text-xs font-semibold rounded-lg hover:bg-[#222222] transition-colors shadow-sm flex items-center gap-2 self-start"
                >
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg text-xs font-bold transition-all flex items-center gap-2 flex-shrink-0 ${
                      selectedSemester === sem
                        ? 'bg-black text-white shadow-sm'
                        : 'bg-white text-[#666666] border border-[#eaeaea] hover:border-black'
                    }`}
                  >
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                    <div className="glass-card p-4 rounded-xl">
                      ...
                      <p className="text-2xl font-black text-black mt-1">{semesterResult.sgpa}</p>
                    </div>
                    <div className="glass-card p-4 rounded-xl">
                      <span className="text-[10px] font-bold text-[#888888] uppercase">Semester Credits</span>
                      <p className="text-2xl font-black text-black mt-1">{semesterResult.totalCredits}</p>
                    </div>
                    <div className="glass-card p-4 rounded-xl">
                      <span className="text-[10px] font-bold text-[#888888] uppercase">Aggregate %</span>
                      <p className="text-2xl font-black text-black mt-1">{semesterResult.percentage}%</p>
                    </div>
                    <div className="glass-card p-4 rounded-xl">
                      <span className="text-[10px] font-bold text-[#888888] uppercase">Result Status</span>
                      <p className="text-2xl font-black text-emerald-600 mt-1">{semesterResult.resultStatus}</p>
                    </div>
                  </div>
                          ...
                          {semesterResult.subjects.map((sub, idx) => (
                            <tr key={idx} className="hover:bg-[#fafafa] transition-colors">
                              <td className="px-6 py-4">
                                <span className="font-mono font-bold text-xs text-black block">{sub.subjectCode}</span>
                              ...
                              <td className="px-4 py-4 text-center text-xs font-bold text-black">{sub.credits}</td>
                              <td className="px-4 py-4 text-center text-xs font-mono font-bold text-black">{sub.mseMarks}</td>
                              <td className="px-4 py-4 text-center text-xs font-mono font-bold text-black">{sub.eseMarks}</td>
                              <td className="px-4 py-4 text-center text-xs font-mono font-black text-black">{sub.totalMarks}</td>
                              <td className="px-4 py-4 text-center">
                                <span className={`inline-flex items-center justify-center w-7 h-7 rounded text-xs font-black ${
                              ...
                              <td className="px-6 py-4 text-right font-mono font-bold text-xs text-black">
          ...
          {activeModule === 'gradesheet' && semesterResult && (
            <div className="animate-fade-in space-y-6">
              ...
              <div className="flex items-center justify-between print-hidden">
                <div className="flex items-center gap-2">
                  <button onClick={() => setActiveModule('results')} className="text-xs font-bold text-[#666666] hover:text-black">
                    ← Back to Results
                  </button>
                  <span className="text-xs text-gray-300">|</span>
                  <span className="text-xs font-bold text-black">Semester {selectedSemester} Official Transcript</span>
                </div>

                <button 
                  onClick={() => window.print()}
                  className="px-4 py-2 bg-black text-white text-xs font-bold rounded-lg hover:bg-[#222222] transition-colors shadow-sm flex items-center gap-2"
                >
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"></path></svg>
              ...
              <div className="bg-white p-8 md:p-12 rounded-2xl border border-[#eaeaea] print-sheet space-y-6 shadow-sm">
                ...
                <div className="text-center border-b-2 border-black pb-6 space-y-1">
                  ...
                  <div className="pt-2">
                    <span className="inline-block border-2 border-black px-4 py-1 text-xs font-black uppercase tracking-widest text-black">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs py-2 border-b border-[#eaeaea]">
                  <div>
                    ...
                    <span className="font-bold text-black block">{semesterResult.studentName}</span>
                  </div>
                  <div>
                    <span className="text-[#888888] font-bold block text-[10px] uppercase">Permanent Reg. No (PRN)</span>
                    <span className="font-mono font-bold text-black block">{semesterResult.prnNumber}</span>
                  </div>
                  <div>
                    <span className="text-[#888888] font-bold block text-[10px] uppercase">Department / Program</span>
                    <span className="font-bold text-black block">{semesterResult.department}</span>
                  </div>
                  <div>
                    <span className="text-[#888888] font-bold block text-[10px] uppercase">Examination Session</span>
                    <span className="font-bold text-black block">{semesterResult.examSession}</span>
                  </div>
                </div>

                {/* Grade Table */}
                <table className="w-full text-left text-xs border border-black">
                  <thead className="bg-[#f0f0f0] border-b border-black font-black uppercase">
                    <tr>
                      <th className="p-2 border-r border-black">Course Code</th>
                      <th className="p-2 border-r border-black">Course Title</th>
                      <th className="p-2 text-center border-r border-black">Credits</th>
                      <th className="p-2 text-center border-r border-black">MSE (30)</th>
                      <th className="p-2 text-center border-r border-black">ESE (70)</th>
                      <th className="p-2 text-center border-r border-black">Total</th>
                      <th className="p-2 text-center border-r border-black">Grade</th>
                  ...
                  <tbody className="divide-y divide-black font-medium">
                    {semesterResult.subjects.map((sub, idx) => (
                      <tr key={idx}>
                        <td className="p-2 font-mono font-bold border-r border-black">{sub.subjectCode}</td>
                        <td className="p-2 border-r border-black">{sub.subjectName}</td>
                        <td className="p-2 text-center font-bold border-r border-black">{sub.credits}</td>
                        <td className="p-2 text-center font-mono border-r border-black">{sub.mseMarks}</td>
                        <td className="p-2 text-center font-mono border-r border-black">{sub.eseMarks}</td>
                        <td className="p-2 text-center font-mono font-bold border-r border-black">{sub.totalMarks}</td>
                        <td className="p-2 text-center font-black border-r border-black">{sub.grade}</td>
                ...
                <div className="grid grid-cols-3 gap-4 border border-black p-4 text-center bg-[#fafafa]">
                  <div>
                    <span className="text-[10px] font-black uppercase text-[#666666] block">Semester SGPA</span>
                    <span className="text-2xl font-black text-black">{semesterResult.sgpa}</span>
                  </div>
                  <div>
                    <span className="text-[10px] font-black uppercase text-[#666666] block">Total Credits Earned</span>
                    <span className="text-2xl font-black text-black">{semesterResult.totalCredits}</span>
                  </div>
                  <div>
                    <span className="text-[10px] font-black uppercase text-[#666666] block">Result Status</span>
                    <span className="text-2xl font-black text-black">{semesterResult.resultStatus}</span>
                  </div>
                </div>
                ...
                <div className="flex justify-between items-end pt-12 text-xs">
                  ...
                  <div className="text-center space-y-1">
                    <div className="w-36 border-b border-black pb-1 mb-1 font-serif italic text-sm">
                      Vikramaditya S.
                    </div>
          ...
          {activeModule === 'attendance' && attendanceData && (
            <div className="animate-fade-in space-y-6">
              ...
              <div>
                <h1 className="text-2xl font-black text-black">Attendance & Defaulter Tracking</h1>
                  ...
                  <div key={item.id} className="glass-card p-6 rounded-2xl flex flex-col justify-between">
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <span className="font-mono text-xs font-bold text-black">{item.subjectCode}</span>
                      ...
                      <h4 className="text-sm font-bold text-black">{item.subjectName}</h4>
                      <p className="text-xs text-[#777777] mt-0.5">{item.type}</p>
                    </div>

                    <div className="mt-6 space-y-2">
                      <div className="flex items-center justify-between text-xs">
                        <span className="text-[#666666]">Attended: <strong className="text-black font-mono">{item.totalAttended} / {item.totalConducted}</strong> sessions</span>
                        <span className="font-mono font-black text-sm text-black">{item.percentage}%</span>
                      </div>
                      ...
                      <div className="w-full bg-[#eaeaea] h-2 rounded-full overflow-hidden">
                        <div 
                          className={`h-full rounded-full transition-all duration-500 ${
                            item.isDefaulter ? 'bg-red-500' : 'bg-black'
                          }`}
          ...
          {activeModule === 'hallticket' && hallTicket && (
            <div className="animate-fade-in space-y-6">
              ...
              <div className="flex items-center justify-between print-hidden">
                <div>
                  <h1 className="text-2xl font-black text-black">Digital Examination Hall Ticket</h1>
              ...
              <div className="bg-white p-8 md:p-10 rounded-2xl border border-[#eaeaea] print-sheet space-y-6 shadow-sm">
                ...
                <div className="text-center border-b-2 border-black pb-4 space-y-1">
                  <h2 className="text-lg font-black uppercase tracking-tight text-black">{hallTicket.institution}</h2>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs py-2 border-b border-[#eaeaea]">
                  <div>
                    ...
                    <span className="font-bold text-black block">{hallTicket.studentName}</span>
                  </div>
                  <div>
                    <span className="text-[#888888] font-bold text-[10px] uppercase block">PRN Number</span>
                    <span className="font-mono font-bold text-black block">{hallTicket.prnNumber}</span>
                  </div>
                  <div>
                    <span className="text-[#888888] font-bold text-[10px] uppercase block">Department</span>
                    <span className="font-bold text-black block">{hallTicket.department}</span>
                  </div>
                  <div>
                    <span className="text-[#888888] font-bold text-[10px] uppercase block">Exam Center</span>
                    <span className="font-bold text-black block">VIT Pune (Main)</span>
                  </div>
                </div>
                ...
                <table className="w-full text-left text-xs border border-black">
                  <thead className="bg-[#f0f0f0] border-b border-black font-black uppercase">
                    <tr>
                      <th className="p-2 border-r border-black">Course Code</th>
                      <th className="p-2 border-r border-black">Course Title</th>
                      <th className="p-2 border-r border-black text-center">Exam Date</th>
                      <th className="p-2 border-r border-black text-center">Slot Time</th>
                  ...
                  <tbody className="divide-y divide-black font-medium">
                    {hallTicket.timetable.map((t, idx) => (
                      <tr key={idx}>
                        <td className="p-2 font-mono font-bold border-r border-black">{t.subjectCode}</td>
                        <td className="p-2 border-r border-black">{t.subjectName}</td>
                        <td className="p-2 text-center border-r border-black font-bold">{t.examDate}</td>
                        <td className="p-2 text-center border-r border-black text-[#555555]">{t.examTime}</td>
                ...
                {/* Instructions */}
                <div className="border border-black p-4 text-[11px] space-y-1 bg-[#fafafa]">
                  <strong className="block font-bold uppercase text-black">Important Examination Regulations:</strong>
                ...
                <div className="flex justify-between items-end pt-8 text-xs">
                  <div className="text-center space-y-1">
                    <div className="w-32 border-b border-black pb-1 mb-1"></div>
                    <span className="font-bold text-[10px] uppercase">Candidate Signature</span>
                  </div>
                  <div className="text-center space-y-1">
                    <div className="w-32 border-b border-black pb-1 mb-1 font-serif italic text-xs">Dr. K. N. Rao</div>
          ...
          {activeModule === 'fees' && feeData && (
            <div className="animate-fade-in space-y-6">
              ...
              <div>
                <h1 className="text-2xl font-black text-black">Fees, Invoices & Receipts</h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="glass-card p-6 rounded-2xl space-y-4">
                  <h3 className="text-sm font-bold text-black">Annual Fee Structure Breakdown (AY 2025-26)</h3>
                  ...
                  <div className="space-y-3">
                    {feeData.feeStructure.map((fee, idx) => (
                      <div key={idx} className="flex items-center justify-between text-xs py-1 border-b border-[#eaeaea]">
                        ...
                        <span className="font-mono font-bold text-black">₹{fee.amount.toLocaleString()}</span>
                      </div>
                    ))}
                    <div className="flex items-center justify-between text-sm font-black pt-2">
                      <span>Total Semester Dues</span>
                      <span className="font-mono text-black">₹85,000</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="glass-card p-6 rounded-2xl flex flex-col justify-between">
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <span className="px-2.5 py-0.5 rounded-full text-xs font-black bg-emerald-100 text-emerald-700">PAID & VERIFIED</span>
                    </div>
                    <p className="text-3xl font-black text-black">₹85,000.00</p>
                    <p className="text-xs text-[#777777] mt-1">Transaction Ref: <span className="font-mono font-bold text-black">TXN-VIT-89421</span></p>
                  </div>

                  <button 
                    onClick={() => window.print()}
                    className="w-full mt-6 py-2.5 bg-black text-white text-xs font-bold rounded-lg hover:bg-[#222222] transition-colors shadow-sm flex items-center justify-center gap-2"
                  >
          ...
          {activeModule === 'notices' && (
            <div className="animate-fade-in space-y-6">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                  <h1 className="text-2xl font-black text-black">Notices & Academic Circulars</h1>
              ...
              <div className="space-y-4">
                {filteredNotices.map((notice) => (
                  <div key={notice.id} className="glass-card p-6 rounded-2xl hover:border-black transition-all space-y-3">
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex items-center gap-2">
                        ...
                        {notice.priority === 'URGENT' && (
                          <span className="text-[10px] font-black text-red-600 uppercase">URGENT ACTION</span>
                        )}
                      </div>
                      <span className="text-xs text-[#888888] font-medium">{notice.date}</span>
                    </div>
                    ...
                    <div className="pt-2 border-t border-[#eaeaea] flex items-center justify-between text-xs text-[#888888]">
                      <span>Issued by: <strong className="text-black">{notice.author}</strong></span>
          ...
          {activeModule === 'profile' && overview && (
            <div className="animate-fade-in space-y-6 max-w-3xl">
              ...
              <div>
                <h1 className="text-2xl font-black text-black">Student Profile & Credentials</h1>
              ...
              <div className="glass-card rounded-2xl overflow-hidden">
                <div className="p-8 border-b border-[#eaeaea] flex items-center gap-6 bg-gradient-to-r from-white to-gray-50">
                  <div className="w-20 h-20 bg-black text-white rounded-2xl flex items-center justify-center text-3xl font-black shadow-md flex-shrink-0">
                    {overview.student.name.charAt(0)}
                  </div>
                  <div>
                    <h2 className="text-2xl font-black text-black">{overview.student.name}</h2>
                ...
                <div className="p-8">
                  <dl className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-6 text-xs">
                    <div>
                      ...
                      <dd className="mt-1 font-semibold text-black text-sm">{overview.student.email}</dd>
                    </div>
                    <div>
                      <dt className="font-bold text-[#888888] uppercase text-[10px]">Mobile Number</dt>
                      <dd className="mt-1 font-semibold text-black text-sm">{overview.student.phone}</dd>
                    </div>
                    <div>
                      <dt className="font-bold text-[#888888] uppercase text-[10px]">Department</dt>
                      <dd className="mt-1 font-semibold text-black text-sm">{overview.student.department}</dd>
                    </div>
                    <div>
                      <dt className="font-bold text-[#888888] uppercase text-[10px]">Academic Batch</dt>
                      <dd className="mt-1 font-semibold text-black text-sm">{overview.student.batch}</dd>
                    </div>
                    <div>
                      <dt className="font-bold text-[#888888] uppercase text-[10px]">Current Semester</dt>
                      <dd className="mt-1 font-semibold text-black text-sm">Semester {overview.student.currentSemester}</dd>
                    </div>
                    <div>
                      <dt className="font-bold text-[#888888] uppercase text-[10px]">Degree Program</dt>
                      <dd className="mt-1 font-semibold text-black text-sm">Bachelor of Technology (B.Tech)</dd>
                    </div>
                  </dl>
                </div>
              </div>
